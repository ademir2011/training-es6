...
var acelerar = function acelerar() {
  return console.log("vrum vrum");
};
...
var dimensoes = function dimensoes(comprimento, alturaInicial) {
  return {
...
var pessoa = {
  nome: "Goku",
  equipe: "Guerreiro Z",
  seApresentar: function seApresentar(pessoa) {
    console.log("Oi, eu sou o ".concat(this.nome, " !"));
  }
};
...
var criaObjetoComCaracteristicas = function criaObjetoComCaracteristicas(caracteristicas) {
  caracteristicas.idade, caracteristicas.nome;
};
/*
Exercício 5 - Esse tal de JSON
Responda: O que é um JSON?
*/
// É uma notação de objeto em JavaScript, servindo para representar uma objeto em um formato javascript